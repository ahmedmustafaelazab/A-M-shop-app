...
import 'package:shop_app/modules/Screens/favorites_screen/favorites.dart';
  ...
  Widget build(context){
    ...
    return Builder(
        builder: (context) {
          ...
          return Scaffold(
              appBar: AppBar(title: const Text("Profile",style: TextStyle(color: thirdColor)),elevation: 0,backgroundColor: mainColor,foregroundColor: mainColor,),
                        ...
                        Expanded(
                            ...
                            Column(
                              ...
                              [
                                ...
                                Text(cubit.userModel!.name.toString(),style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: mainColor),),
                                const SizedBox(height: 10),
                                Text(cubit.userModel!.email.toString(),style: const TextStyle(color:mainColor,fontWeight: FontWeight.bold,fontSize: 16),)
                              ],
                            ) :
